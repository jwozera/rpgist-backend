const makeErrorResponse = (description: string) => ({
  description,
  content: {
    'application/json': {
      schema: {
  ...
  paths: {
    ...
    '/api/users/me': {
      ...
      patch: {
        ...
        description:
          'Updates the authenticated user profile. Only the account owner may modify their name, email, or password.',
        tags: ['Users'],
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
      ...
      delete: {
        ...
        description:
          'Deletes the authenticated user account. This action cascades to owned characters, games, and memberships.',
        tags: ['Users'],
        security: [{ bearerAuth: [] }],
        responses: {
          '204': {
    ...
    '/api/game-characters': {
      ...
      get: {
        ...
        description:
          'Returns memberships for the authenticated user. Provide gameId to list all characters pending/approved in a specific owned game.',
        tags: ['Game Characters'],
        security: [{ bearerAuth: [] }],
        parameters: [
          {
    ...
    '/api/characters/{id}': {
      get: {
        ...
        description:
          'Load character data with computed values. Accessible to the owner and to the game master of any approved game this character participates in.',
        tags: ['Characters'],
        security: [{ bearerAuth: [] }],
        parameters: [
          {
